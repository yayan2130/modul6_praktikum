...
class adapter (val phoneItemList: List<data>, val clickListener: (data) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    class PartViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        fun bind(phone: data,clickListener: (data) -> Unit) {
